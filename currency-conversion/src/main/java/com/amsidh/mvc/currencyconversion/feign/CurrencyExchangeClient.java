...
//@FeignClient(name = "currency-exchange",  url = "${CURRENCY_EXCHANGE_URL:http://localhost:8181}", fallback = CurrencyExchangeClientFallback.class)
@FeignClient(name = "currency-exchange", fallback = CurrencyExchangeClientFallback.class)
